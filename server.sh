...
# ldapsearch -D "cn=admin,cn=config" -w secret -b olcDatabase={2}bdb,cn=config
...
# ldapsearch -D "cn=admin,cn=config" -w secret -b cn=config olcDatabase={2}bdb
# ldapsearch -D "cn=admin,cn=config" -w secret -b cn=config olcDatabase={1}monitor
# ldapsearch -D "cn=admin,cn=config" -w secret -b cn=config 'cn=module*'
# ldapsearch -D "cn=Manager,dc=syco,dc=net" -w secret  olcDatabase={1}monitor,cn=config


# ldapsearch -D "cn=admin,cn=config" -w secret -b cn=config 'cn=module*'
# ldapsearch -D "cn=admin,cn=config" -w secret -b dc=syco,dc=net cn=default
# ldapsearch -D "cn=admin,cn=config" -w secret -b olcDatabase={2}bdb,cn=config olcOverlay=ppolicy
